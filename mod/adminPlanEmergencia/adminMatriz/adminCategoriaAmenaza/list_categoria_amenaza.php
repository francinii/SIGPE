...
<div class="dataTables_wrapper form-inline dt-bootstrap">
    ...
    <?php if (check_permiso($mod4, $act3, $user_rol)) { ?>
        <div class="text-center"><a class="btn btn-success" name="submit" onclick="javascript:OpcionMenu('mod/adminPlanEmergencia/adminMatriz/adminCategoriaAmenaza/new_categoria_amenaza.php?','find_key=' + jQuery('#select_tipo_amenaza').val());"><i class='fa fa-plus fa-inverse'></i> <?= $vocab["symbol_add"] ?> <?= $vocab["categoria_amenaza_title"] ?></a></div>
    <?php } ?>
</div>
