...
<div class="well well-sm">
    ...
    <div class="text-center">
        ...
        <span class="text-center">
                <a class="btn btn-success"  onclick="javascript:guardarBrigadistas('<?= $idPlanEmergencia ?>', 1, '<?= $tablaID ?>')" name="submit" ><i class="fa fa-rotate-right fa-inverse"></i> <?= $vocab["symbol_save"] . " " . $vocab["datos_generares_siguente"] ?></a>
            </span>
        <?php } ?>
    </div>
</div>