...
<div class="text-center">
    <?php if ($editar) { ?>
        ...
        <span class="text-center">
            <a class="btn  btn-success"  onclick="javascript:guardarDatosIdentificacionPeligros('<?= $idPlanEmergencia ?>', 1)" name="submit"><i class="fa fa-rotate-left"></i> <?= $vocab["symbol_save"] . " " . $vocab["datos_generares_siguente"] ?></a>
        </span>
    <?php } ?>
</div>
