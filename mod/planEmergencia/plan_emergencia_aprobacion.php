...
<?php if (check_permiso($mod4, $act3, $user_rol)) { ?>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <a class="btn btn-success btn-group-justified"  name="submit" onclick="javascript:update_aprobacion(<?= $id ?>, '<?= $centro ?>',<?= $version ?>);"><i class="fa fa-save fa-inverse"> </i> <?= $vocab["symbol_save"] ?> <?= $vocab["inicio_save_print"] ?>  </a>
                </div>
<?php } ?> 
