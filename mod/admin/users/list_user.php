...
$sAjaxSource = $mySessionController->getVar('cds_domain') . $mySessionController->getVar('cds_locate') . 'mod/adminPlanEmergencia/adminZonasTrabajo/ajax_list_zona_trabajo.php';
?>
<!--  ****** Titulo ***** -->
