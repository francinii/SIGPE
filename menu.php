    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar" aria-expanded="false" style="height: 1px;">
                ...
                <ul class="nav navbar-nav">                 
                    ...
                    <!-- PERFIL -->
                    <li><a href='#' class="Menuprincipal" onclick="javascript:OpcionMenu('mod/admin/users/edit_perfil.php?', '');"><span> <i class="fa fa-user fa-inverse"></i> <?= $vocab["menu_perfil"] ?></span></a></li>
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <?php if (check_permiso($mod2, $act2, $user_rol)) { ?>
                                                <li><a  class="Menuprincipal"  onclick="javascript:OpcionMenu('mod/admin/rolls/list_roll.php?', '');"><span> <i class="fa fa-list text-primary"></i> <?= $vocab["menu_list"] ?></span></a></li>
                                            <?php } ?>
                                            <?php if (check_permiso($mod2, $act3, $user_rol)) { ?>
                                                <li><a  class="Menuprincipal"  onclick="javascript:OpcionMenu('mod/admin/rolls/new_roll.php?', '');"><span><i class="fa fa-plus text-success"></i> <?= $vocab["menu_add"] ?></span></a></li>
                                            <?php } ?>
                                        </ul>
                                    </li>
                                <?php } ?>
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <?php if (check_permiso($mod3, $act2, $user_rol)) { ?>
                                                <li><a  class="Menuprincipal"  onclick="javascript:OpcionMenu('mod/admin/users/list_user.php?', '');"><span> <i class="fa fa-list text-primary"></i>  <?= $vocab["menu_list"] ?></span></a></li>
                                            <?php } ?>
                                            <?php if (check_permiso($mod3, $act3, $user_rol)) { ?>
                                                <li><a  class="Menuprincipal"  onclick="javascript:OpcionMenu('mod/admin/users/new_user.php?', '');"><span><i class="fa fa-plus text-success"></i> <?= $vocab["menu_add"] ?></span></a></li>
                                            <?php } ?>
                                        </ul>
                                    <?php } ?>
                            </ul>
                            ...
                            <ul class="dropdown-menu"> 
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <?php if (check_permiso($mod4, $act3, $user_rol)) { ?>
                                                <li><a  class="Menuprincipal"  onclick="javascript:OpcionMenu('mod/adminPlanEmergencia/adminSedes/new_sedes.php?', '');"><span><i class="fa fa-plus text-success"></i> <?= $vocab["menu_add"] ?></span></a></li>
                                            <?php } ?>
                                        </ul>
                                    </li>
                                <?php } ?> 
                                ...
                                <?php if (check_permiso($mod4, $act1, $user_rol)) { ?>
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <?php } ?>
                                            <?php if (check_permiso($mod4, $act3, $user_rol)) { ?>
                                                <li><a  class="Menuprincipal"  onclick="javascript:OpcionMenu('mod/adminPlanEmergencia/adminZonaTrabajo/new_zona_trabajo.php?', '');"><span><i class="fa fa-plus text-success"></i> <?= $vocab["menu_add"] ?></span></a></li>
                                            <?php } ?>
                                        </ul>
                                    </li>
                                <?php } ?> 
                                ...
                                <?php if (check_permiso($mod4, $act1, $user_rol)) { ?>
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <?php } ?>
                                            <?php if (check_permiso($mod4, $act3, $user_rol)) { ?>
                                                <li><a  class="Menuprincipal"  onclick="javascript:OpcionMenu('mod/adminPlanEmergencia/adminCapitulos/new_capitulo.php?', '');"><span><i class="fa fa-plus text-success"></i> <?= $vocab["menu_add"] ?></span></a></li>
                                            <?php } ?>                                        
                                        </ul>
                                    </li>
                                <?php } ?>                                
                                ...
                                <?php if (check_permiso($mod4, $act1, $user_rol)) { ?>
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <?php } ?>
                                            <?php if (check_permiso($mod4, $act3, $user_rol)) { ?>
                                                <li><a  class="Menuprincipal"  onclick="javascript:OpcionMenu('mod/adminPlanEmergencia/adminSubcapitulos/new_subcapitulo.php?', '');"><span><i class="fa fa-plus text-success"></i> <?= $vocab["menu_add"] ?></span></a></li>
                                            <?php } ?>                                        
                                        </ul>
                                    </li>
                                <?php } ?>
                                ...
                                <?php if (check_permiso($mod4, $act1, $user_rol)) { ?>
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <?php if (check_permiso($mod4, $act2, $user_rol)) { ?>
                                                <li><a  class="Menuprincipal"  onclick="javascript:OpcionMenu('mod/adminPlanEmergencia/adminFormularios/list_formulario.php?', '');"><span> <i class="fa fa-list text-primary"></i>  <?= $vocab["formulario_admin"] ?></span></a></li>
                                            <?php } ?>                                                                             
                                        </ul>
                                    </li>
                                <?php } ?>
